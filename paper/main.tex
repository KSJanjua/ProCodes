...
%------------------------------------------------------------------------------
\title{Occlusion-Aware Instance-Level Video Depth for Human Groups
       on a Single-Sensor RGB-D Dataset}
%  Alt (dataset framing): "A Single-Sensor RGB-D Benchmark for Occlusion-Aware
%    Instance-Level Video Depth of Human Groups"
%  Alt (adaptation framing): "Adapting Occlusion-Aware Instance-Level Video
%    Depth to Single-Sensor RGB-D Human Activity"
...
% TODO (dataset framing): add a "depth / RGB-D datasets" paragraph positioning
% the gap our dataset fills (e.g. indoor RGB-D and driving depth benchmarks,
% and any human-group depth datasets). Deferred until verified dataset
% citations are added to references.bib -- no fabricated citations.
